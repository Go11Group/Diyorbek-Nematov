...
type TransportServiceClient interface {
	GetBusSchedule(ctx context.Context, in *GetBusScheduleRequest, opts ...grpc.CallOption) (*GetBusScheduleResponse, error)
	TrackBusLocation(ctx context.Context, in *TrackBusLocationRequest, opts ...grpc.CallOption) (*TrackBusLocationResponse, error)
...
func (c *transportServiceClient) GetBusSchedule(ctx context.Context, in *GetBusScheduleRequest, opts ...grpc.CallOption) (*GetBusScheduleResponse, error) {
...
func (c *transportServiceClient) TrackBusLocation(ctx context.Context, in *TrackBusLocationRequest, opts ...grpc.CallOption) (*TrackBusLocationResponse, error) {
...
type TransportServiceServer interface {
	GetBusSchedule(context.Context, *GetBusScheduleRequest) (*GetBusScheduleResponse, error)
	TrackBusLocation(context.Context, *TrackBusLocationRequest) (*TrackBusLocationResponse, error)
...
func (UnimplementedTransportServiceServer) GetBusSchedule(context.Context, *GetBusScheduleRequest) (*GetBusScheduleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBusSchedule not implemented")
}
func (UnimplementedTransportServiceServer) TrackBusLocation(context.Context, *TrackBusLocationRequest) (*TrackBusLocationResponse, error) {
...
func _TransportService_GetBusSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransportServiceServer).GetBusSchedule(ctx, req.(*GetBusScheduleRequest))
	}
...
func _TransportService_TrackBusLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TrackBusLocationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransportServiceServer).TrackBusLocation(ctx, req.(*TrackBusLocationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
