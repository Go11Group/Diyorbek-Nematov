...
type WeatherServiceClient interface {
	...
	GetWeatherForecast(ctx context.Context, in *WeatherForecastRequest, opts ...grpc.CallOption) (*WeatherForecastResponse, error)
...
func (c *weatherServiceClient) GetWeatherForecast(ctx context.Context, in *WeatherForecastRequest, opts ...grpc.CallOption) (*WeatherForecastResponse, error) {
...
type WeatherServiceServer interface {
	...
	GetWeatherForecast(context.Context, *WeatherForecastRequest) (*WeatherForecastResponse, error)
...
func (UnimplementedWeatherServiceServer) GetWeatherForecast(context.Context, *WeatherForecastRequest) (*WeatherForecastResponse, error) {
...
func _WeatherService_GetWeatherForecast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).GetWeatherForecast(ctx, req.(*WeatherForecastRequest))
	}
	return interceptor(ctx, in, info, handler)
}
